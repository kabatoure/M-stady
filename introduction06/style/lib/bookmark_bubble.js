...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubbleInner.style.width = '1000px';
  //  bubbleInner.style.height = '255px';
  bubbleInner.style.height = '290px';
  bubbleInner.style.margin = isIpad ? '0 0 0 82px' : '0 auto';
  bubbleInner.style.border = '2px solid #fff';
  bubbleInner.style.padding = '25px 20px 0px 10px';
  ...
  bubbleInner.style.font = '44px/48px sans-serif';
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    ...
    bubbleInner.innerHTML = 'プチゲームをホーム画面に追加しよう！<br />ここをタップして「ホーム画面に追加」を押してね。';
  } else {
    /*bubbleInner.innerHTML = 'Install this web app on your phone: ' +
  ...
  icon.style.margin = '5px 10px 10px 10px';
  icon.style.background =
      '#fff url(' + this.getIconUrl_() + ') no-repeat -1px -1px';
  icon.style.WebkitBackgroundSize = '250px';
...
/*  var close = document.createElement('a');
  ...
  close.style.border = '35px solid transparent';
  close.style.background =
      'url(' + this.IMAGE_CLOSE_DATA_URL_ + ') no-repeat';
  close.style.WebkitBackgroundSize = '75px';
